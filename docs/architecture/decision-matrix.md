...
- Asset vendoring: **DONE (slice 2)** — local assets + `public/og-image.png`; env inventory still **ACCEPTED RISK** (confirm Vercel values at deploy without secrets in git).
