...
| Asset vendoring (Lovable/CDN)    | **ACCEPTED RISK:** GO without pre-deciding every file; **remember** — execute as migration **slice 2**; inventory `src/assets/*.asset.json` + CDN URLs; vendor/re-host; broken-image scan ([10-styling-and-assets.md](../frontend/10-styling-and-assets.md)) | Slice 2 complete + no Lovable-hosted image dependency |
