...
- [x] Asset vendoring plan: **DONE (slice 2)** — local `src/assets/*` + `public/og-image.png`; Lovable `*.asset.json` / `__l5e` removed; `npm run scan:assets` ([10-styling-and-assets.md](../frontend/10-styling-and-assets.md); [deferred-decisions.md](deferred-decisions.md))
