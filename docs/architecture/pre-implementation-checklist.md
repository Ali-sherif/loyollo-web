...
- [x] Asset vendoring plan: **ACCEPTED RISK** — **remains open until slice 2 done**; vendor/re-host Lovable/CDN assets per [10-styling-and-assets.md](../frontend/10-styling-and-assets.md); broken-image scan at slice acceptance ([deferred-decisions.md](deferred-decisions.md))
