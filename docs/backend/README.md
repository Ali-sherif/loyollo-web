...
| [api-contract.md](api-contract.md) | Endpoint shapes (analytics ROI, `POST /api/insights/:key/actions`, catalog redemption lifecycle, Shop QR resolve **pending BO item 15**) |
