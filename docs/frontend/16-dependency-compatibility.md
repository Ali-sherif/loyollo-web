...
| -------------------------------------- | -------------------- | --------------------------------------------------------------------------- | ----------------------------- | -------- | ------------------------------------------------------------ |
| `next`                                 | `16.3.0`             | Target 16.3.x Active LTS                                                    | Framework                     | Critical | Installed; keep on 16.3.x patches                            |
| `typescript`                           | `~6.0.3`             | Target 6.0.x                                                                | Build                         | High     | Validated with Next 16.3.x (`typecheck:next` / `build:next`) |
...
| `@types/node`                          | `^24.13.3`           | Align with Node 24 LTS target                                               | Build                         | Medium   | Pinned to Node 24 line; runtime via `.nvmrc` / `engines`     |
...
| Lovable error reporting hook           | host-injected global | Not portable; must leave with Lovable withdrawal                            | Client                        | High     | Remove; choose portable observability later                  |
