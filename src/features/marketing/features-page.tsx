    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main>
        ...
        <FeatureSection
          ...
          groups={customerMgmt}
          image={assetSrc(customerProfileImg)}
        ...
        <div className="bg-navy-50/40">
          <FeatureSection
            ...
            image={assetSrc(loyaltyProgramImg)}
        ...
        <FeatureSection
          ...
          groups={campaigns}
          image={assetSrc(campaignBuilderImg)}
          ...
          >
            ...
            <div className="relative">
              <div className="mx-auto inline-flex h-14 w-14 items-center justify-center rounded-full bg-[#15264F] text-gold-300">
                <img src={assetSrc(iconAsset)} alt="Loyollo" className="h-6 w-auto object-contain" />
              </div>
