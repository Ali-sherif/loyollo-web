...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact — Loyalty" },
      {
        name: "description",
        content:
          "Get in touch with the Loyalty team. Live chat, help center, phone support, or send us a message — we'd love to hear from you.",
      },
      { property: "og:title", content: "Contact — Loyalty" },
      {
        property: "og:description",
        content:
          "Get in touch with the Loyalty team. Live chat, help center, phone support, or send us a message.",
      },
