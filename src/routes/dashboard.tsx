  ...
  head: () => ({
    meta: [
      { title: "Dashboard — Loyalty" },
      {
        name: "description",
        content:
          "Your loyalty program dashboard. Track customers, rewards, and campaigns.",
      },
  ...
  const checklist: ChecklistItem[] = [
    {
      ...
      description:
        "Set up how customers earn points and engage with your business.",
      done: hasProgram,
      ...
      <div className="mx-auto max-w-[1120px] rounded-[16px] bg-white p-6 shadow-[0_1px_2px_rgba(15,28,61,0.04)] sm:p-8 lg:p-10">
        <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_minmax(0,420px)] lg:gap-10">
          ...
          <section className="flex flex-col justify-center">
            ...
            >
              Let's Launch Your Loyalty Program{" "}
              <span aria-hidden>🚀</span>
            </h1>
            <p className="mt-3 max-w-[480px] text-[14px] leading-[1.6] text-[#525252]">
              You're just a few steps away from turning first-time visitors
              into loyal customers. Complete the setup checklist below to
              start collecting customers, rewarding loyalty, and growing
              repeat business.
            </p>
            <button
              type="button"
          ...
          >
            <div className="flex items-center justify-between gap-3">
              <h2
                ...
                className="text-[20px] font-bold text-[#0a152f]"
              >
                Getting Started
              </h2>
