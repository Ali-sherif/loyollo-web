...
export const Route = createFileRoute("/guide")({
  head: () => ({
    meta: [
      { title: "Guide — How Loyalty Works" },
      {
        name: "description",
        content:
          "A step-by-step guide to launching your loyalty program: sign up, configure rewards, print your QR code, and start earning repeat customers in minutes.",
      },
      { property: "og:title", content: "Guide — How Loyalty Works" },
      {
        property: "og:description",
        content:
          "From sign-up to your first enrolled customer in about 10 minutes. See the full setup, business types supported, and time-to-value milestones.",
      },
