...
import loyolloLogoSignin from "@/assets/loyollo-logo-signin.svg.asset.json";
...
export const Route = createFileRoute("/signin")({
  head: () => ({
    meta: [
      { title: "Sign in to your account — Loyalty" },
      {
        name: "description",
        content:
          "Sign in to your Loyalty account to manage your loyalty program and grow your business.",
      },
      { property: "og:title", content: "Sign in — Loyalty" },
      {
        property: "og:description",
        content: "Sign in to manage your loyalty program.",
      },
